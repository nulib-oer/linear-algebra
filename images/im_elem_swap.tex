...
\pagestyle{empty}
          ...
          \matrix[Matrix] at (10,0) (M2){ % Matrix contents
       \amp   \amp  \amp \text{$i$-th} \amp \amp\text{$j$-th} \amp \\
     \amp 1 \amp 0 \amp 0 \amp \dots \amp 0 \amp 0\\
  \amp  \amp \vdots \amp  \amp  \amp \vdots \amp \\
   \text{$i$-th}    \amp 0\amp 0\amp 0   \amp \dots \amp1   \amp0   \\
   \amp  \amp \vdots \amp  \amp  \amp \vdots \amp \\
    \text{$j$-th} \amp 0 \amp 0 \amp 1 \amp \dots\amp 0 \amp 0 \\
     \amp  \amp \vdots \amp  \amp  \amp \vdots \amp  \\
     \amp 0 \amp 0\amp 0 \amp \dots \amp 0 \amp 1\\
     \amp \amp \amp \amp $\underset{cr_i}{E}$ \\
    };

          \begin{scope}[on background layer]
          \draw[DG,red](M2-6-2.center) --(M2-6-7.center);
   \draw[DG,green](M2-2-6.center) --(M2-8-6.center);
   \draw[DG,red](M2-4-2.center) --(M2-4-7.center);
   \draw[DG,green](M2-2-4.center) --(M2-8-4.center);
\node[DL,fit=(M2-2-2)(M2-8-7)](subM-1){};
               \end{scope}
              \end{tikzpicture}
\end{document}
