...
\pagestyle{empty}
   ...
   \amp   \amp\text{$j$-th}  \amp  \amp\text{$i$-th} \amp \amp \\
 \amp 1 \amp 0 \amp 0 \amp 0 \amp \dots \amp 0\\
 \amp 0 \amp 1 \amp 0 \amp 0 \amp \dots \amp 0\\
\amp \amp  \vdots \amp  \amp  \amp  \vdots \amp   \\
\text{$i$-th} \amp \dots\amp c \amp \dots \amp1  \amp \dots \amp 0 \\
 \amp  \amp \vdots \amp  \amp  \amp \vdots \amp  \\
 \amp 0 \amp 0\amp \dots \amp 0 \amp 0 \amp 1\\
 \amp    \amp    \amp  \amp $\underset{r_i+cr_j}{E}$\\
};
  \begin{scope}[on background layer]
           \node[DL,fit=(M-2-2)(M-7-7)](subM-1){};
           \draw[DG,red](M-5-2.center) --(M-5-7.center);
           \draw[DG,green](M-2-5.center) --(M-7-5.center);
            \draw[DG,green](M-2-3.center) --(M-7-3.center);
           \end{scope}
           \end{tikzpicture}
\end{document}
